<script lang="ts">
    ...
    const bookmarkletScript = `javascript:(function(d,s){s=d.createElement('script');s.src='${__HOSTNAME__}/scripts/chuni-tools.js?t='+Math.floor(Date.now()/60000);d.body.append(s);})(document);`
    let copied = false
</script>
